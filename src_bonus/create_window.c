...
void	create_window(t_mlx *mlx)
{
	...
	mlx->game.flash_img = new_image(mlx, mlx->win_w, mlx->win_h);
	mlx->shade = new_image(mlx, IMG * 8 + 1, IMG * 8 + 1);
	fill_circle_gradient_img(mlx->shade, 400, 0xFF000000, 0x00000000);
